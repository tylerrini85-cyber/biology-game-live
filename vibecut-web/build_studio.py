...
CSS = """
  ...
  *{box-sizing:border-box}
  ...
  #vwrap{position:absolute;inset:0;transition:transform .05s linear;transform-origin:center center}
  #videoEl{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;background:#000}
...
<body><div class="wrap">
  ...
  <div class="foot">VibeCut Studio &middot; interactive reference editor &middot; no APIs, no generation. &middot; <b>build: fullframe-5 (fixed overlay)</b></div>
</div>
